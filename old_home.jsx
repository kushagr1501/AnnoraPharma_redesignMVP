...
/* ΓöÇΓöÇΓöÇ Magnetic element ΓöÇΓöÇΓöÇ */
...
/* ΓöÇΓöÇΓöÇ Stagger children ΓöÇΓöÇΓöÇ */
const fadeUp = {
...
const Home = () => {
  ...
  return (
    <>
      {/* ΓöÇΓöÇΓöÇ Main: Hero Section ΓöÇΓöÇΓöÇ */}
      <motion.section
        initial="hidden"
        animate={isLoaded ? "visible" : "hidden"}
        className="relative w-full h-[100dvh] flex flex-col justify-between overflow-hidden bg-[#0a0a0a]"
      >
        {/* Full-screen background image ΓÇö dimmed for mood with parallax */}
        ...
        {/* Bottom bar ΓÇö company info + CTA */}
        <motion.div
          ...
          <div className="max-w-[1600px] mx-auto flex flex-col md:flex-row items-start md:items-center justify-between py-6 lg:py-8 gap-6">
            <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-10">
              ...
              <p className="text-white/50 text-[13px] lg:text-[14px] font-sans leading-relaxed max-w-md">
                Marketing and supply of best-in-class branded generic medicine ΓÇö transforming lives through affordable medication.
              </p>
            </div>
      ...
      {/* ΓöÇΓöÇΓöÇ About Annora ΓöÇΓöÇΓöÇ */}
      ...
      {/* ΓöÇΓöÇΓöÇ Vision, Mission & Values Bento ΓöÇΓöÇΓöÇ */}
